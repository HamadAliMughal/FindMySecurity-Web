...
const StepsSection = () => {
  return (
    <section className="flex flex-col items-center text-center py-16 px-6 text-black bg-gray-100">
      ...
      {/* Signup Button */}
      <button className="mt-10 px-6 py-3 border-2 border-black rounded-full text-black hover:bg-black hover:text-white transition">
        SIGNUP FOR FREE
      </button>
    </section>
  );
...
//       <div className="relative flex flex-col items-center space-y-8">
//         {/* Step 1 */}
//         <div className="bg-blue-100 rounded-lg p-6 flex items-center shadow-md w-full max-w-2xl relative">
//           <div className="flex-grow text-left max-w-xs md:max-w-sm text-justify break-words leading-snug">
//             <p className="text-blue-500 font-semibold">Step 1</p>
//             <h3 className="text-lg font-bold">Download and Sign Up</h3>
...
//         <div className="bg-blue-100 rounded-lg p-6 flex items-center shadow-md w-full max-w-2xl relative">
//           <div className="flex-grow text-left max-w-xs md:max-w-sm text-justify break-words leading-snug">
//             <p className="text-blue-500 font-semibold">Step 2</p>
//             <h3 className="text-lg font-bold">Add Post Sites</h3>
//             <p className="text-gray-600">
//               Turn on the GPS of your smartphone to select the location and start adding multiple sites.
//             </p>
//           </div>
...
//         {/* Step 3 */}
//         <div className="bg-blue-100 rounded-lg p-6 flex items-center shadow-md w-full max-w-2xl">
//           <div className="flex-grow text-left max-w-xs md:max-w-sm text-justify break-words leading-snug">
//             <p className="text-blue-500 font-semibold">Step 3</p>
