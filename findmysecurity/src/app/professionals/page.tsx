...
import ProfessionalsList from "../connecting-business/components/ProfessionalsList";
import MapSection from "../connecting-business/components/MapSection";
import lookingForData from "@/sections/data/secuirty_professional.json";
import { ApiResponse } from "./types"; // If interfaces are in a separate file
  ...
  const fetchData = async () => {
    ...
    try {
      const queryParams = new URLSearchParams({
        ...(selectedCategory && { role: selectedCategory }),
        ...(selectedRole && { subcategory: selectedRole }),
        ...(pc && { pc }),
        ...(distance && { distance }),
      ...
      const apiUrl = `https://ub1b171tga.execute-api.eu-north-1.amazonaws.com/dev/users/professionals?${queryParams}`;
