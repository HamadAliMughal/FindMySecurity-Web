...
const UserProfile: React.FC = () => {
  ...
  if (isLoading) {
    return <div className="min-h-screen bg-gray-100 p-4 md:p-8">Loading...</div>;
  }
  ...
  const profileDetails = [
    { label: "Headline", value: publicProfileData?.profileHeadline || "N/A", icon: <FaUserAlt /> },
    { label: "About Me", value: publicProfileData?.aboutMe || "N/A", icon: <FaUserAlt /> },
    { label: "Availability", value: publicProfileData?.availability || "N/A", icon: <FaClock /> },
    { label: "Experience", value: publicProfileData?.experience || "N/A", icon: <FaBriefcase /> },
    { label: "Gender", value: publicProfileData?.gender || "Not specified", icon: <FaUserAlt /> },
    { label: "Hourly Rate", value: publicProfileData?.hourlyRate ? `$${publicProfileData.hourlyRate}/hr` : "N/A", icon: <FaStar /> },
    { label: "Postcode", value: publicProfileData?.postcode || "N/A", icon: <FaGlobe /> },
    { label: "Website", value: publicProfileData?.website || "N/A", icon: <FaGlobe /> },
    { label: "Qualifications", value: publicProfileData?.qualifications || "N/A", icon: <FaGraduationCap /> },
    { label: "Other Service", value: publicProfileData?.otherService || "N/A", icon: <FaUserShield /> },
    { label: "Home Phone", value: publicProfileData?.homeTelephone || "N/A", icon: <FaPhone /> },
    { label: "Mobile Phone", value: publicProfileData?.mobileTelephone || "N/A", icon: <FaPhoneAlt /> },
    { label: "Selected Services", value: publicProfileData?.selectedServices?.join(", ") || "N/A", icon: <FaCogs /> },
  ];
              ...
              {profileDetails.map((item, index) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 font-semibold mt-1 break-words">{item.value}</p>
                  </div>
                </div>
              ))}
            </div>
