...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    const payload = {
      createdById: JSON.parse(localStorage.getItem('loginData') || '{}').id,
      ...form,
...
const handleDelete = async (jobId: number) => {
  ...
  return (
<div className="container mx-auto flex flex-col  justify-center overflow-hidden px-4 md:px-20 py-8 max-w-full md:max-w-7xl">
